...
const AboutPage: React.FC = () => {
  const teamMembers = [
    ...
    },
    {
      name: "Jiaqi Li",
      description:
        "Graduate student at Columbia University’s Data Science Institute.",
      image: "/assets/Nikita.svg",
    },
    {
      name: "Haiwen Kou",
      ...
      <Container sx={{ py: 6 }}>
        <Box mb={6}>
          ...
          <Typography variant="body1" paragraph>
            Misinformation’s effects, particularly around climate issues, is a
            complex and evolving phenomenon that requires a collective approach
            to address effectively. Limited expert resources, biased ratings
            from crowdsourced veracity judgments, and low public trust without
            engagement in the fact-checking process are key challenges this
            project aims to address.
          </Typography>
          <Typography variant="body1" paragraph>
            We’re building MyFactWiki, a platform that leverages a transparent
            AI model combined with crowdsourced similarity assessments to scale
            expert veracity ratings and collaboratively verify climate news and
            information. Visit the Our Model page to explore the project’s data
            sources and modeling process. This project is a work in progress.
            Check out the Community page to contribute or reach out to us with
